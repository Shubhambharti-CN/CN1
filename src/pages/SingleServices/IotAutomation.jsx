...
<div id="page" className="main  site-content ">
        <HeroSection
        imageUrl="/src/assets/images/banner/inner-header/IOt1_enhanced.jpg"
        title="IoT and Automation"
        description="Providing cutting-edge IoT and automation solutions to enhance efficiency for businesses."
      />
