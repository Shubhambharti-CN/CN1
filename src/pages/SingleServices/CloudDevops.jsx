...
<div id="page" className="main  site-content ">
        <HeroSection
        imageUrl="/src/assets/images/banner/inner-header/cloudsa.jpg"
        title="Cloud & Devops"
