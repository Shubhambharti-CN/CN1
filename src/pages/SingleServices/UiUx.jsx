...
<div id="page" className="main  site-content ">
        <HeroSection
        imageUrl="/src/assets/images/banner/inner-header/UiUx3_enhanced.jpg"
        title="Ui/Ux"
          ...
          <div className="container">
            <div className="section-header ">
              ...
              User-Focused Design
               ...
               <p className="ps-lg-3 mt-4 mt-sm-0"  > We craft exceptional UI/UX designs that drive conversions by focusing on intuitive and visually compelling interfaces.  Our approach centers around several key principles.  We prioritize seamless navigation, ensuring users can easily find what they need through clear menus, calls to action, and streamlined user flows. 
                </p>
            </div>
