...
<div id="page" className="main  site-content ">
        <HeroSection
        imageUrl="/src/assets/images/banner/inner-header/bigdata2_enhanced.jpg"
        title="Big Data"
          ...
          <div className="container">
            <div className="section-header">
              ...
              Harness Big Data for Growth
               ...
               <p className="ps-lg-3 mt-4 mt-sm-0" > Big Data services empower organizations to seamlessly collect, store, process, and analyze vast volumes of structured and unstructured data, unlocking deep insights, optimizing decision-making, and driving sustainable business growth. They facilitate data collection and integration from diverse sources, including traditional databases, social media, IoT devices, and web logs, then provide the means to integrate this data into a unified platform.  
                  </p>
            </div>
