...
const Industries = () => {
  const industriesData = [
    ...
    },
    {
      ...
      title: "Consumer Tech",
      description:
        "Enhancing consumer tech with smarter, faster, and more reliable performance",
    },
    {
      id: 5,
      icon: supply,
      title: "Supply Chain",
      description:
        "Supply chains advance with autonomous tech, boosting efficiency and reducing costs",
    },
    {
      id: 6,
      icon: hospitality,
      title: "Hospitality",
      description:
        "Elevating hospitality and tourism with smart tech for seamless guest experiences",
    },
  ];
            ...
            <div className="section-title mb-5">
              ...
              <div className="industry-description">
                <p className="text-white-50 lead mb-4">
                  How Industries and different departments use Agentic Workflows
                  and Decision Intelligence to Become Decision Centric.
                </p>
                <p className="text-white-50 mb-3">
                  We provide comprehensive Security & Compliance solutions
                  tailored to various industries, Automotive and Industrial,
                  Supply Chain, Hospitality and Tourism, Consumer Tech,
                  Financial Services, Technology, Healthcare, No matter the
                  industry, we help businesses stay secure, compliant, and
