...
const Services = () => {
  const servicesData = [
    ...
    },
    {
      id: 3,
      title: 'Cloud & DevOps',
      description: 'With CIS, accelerate success with our reliable cloud computing services and DevOps solutions for seamless development, continuous delivery, and continuous improvement.',
      icon: CloudDevops,
    ...
    },
    {
      ...
      description: 'At CloudNexus, we help businesses harness the power of IoT and automation to streamline operations, improve productivity, and drive innovation.',
      icon: Iot,
      colorIcon: IotColor
    },
    {
    ...
    },
    {
      id: 6,
      title: 'Big Data',
      description: 'At CIS, unlock insights, drive innovation, and achieve excellence with our strategic data science consulting services.',
      icon: BigData,
  ...
  const ServiceCard = ({ service }) => {
    const handleClick = () => {
      window.location.href = getServicePath(service.title);
    };
      ...
      <section className="space-ptb ellipse-bottom" style={{ paddingTop: '95px', paddingBottom: '95px' }}>
        <div className="container">
          <h4>
            ...
            <br/>
            your business with advanced technologies
          </h4>
