...
import banner_bg_01 from "../../assets/images/banner/banner-03/01.png";
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="banner-conent">
                {/* <span className="sub-title"><img className="img-fluid" src="src/assets/images/logo01.png" alt /> CloudNexus</span> */}
