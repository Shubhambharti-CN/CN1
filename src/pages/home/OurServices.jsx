              ...
              <div className="service-wrapper service-style-1">
                <div className="service-inner">
                  ...
                  <div className="service-content">
                    ...
                    <p>At CIS, unlock insights, drive innovation, and achieve excellence with our strategic data science consulting services.</p>
              ...
              <div className="service-wrapper service-style-1">
                <div className="service-inner">
                  ...
                  <div className="service-content">
                    ...
                    <p>With CIS, accelerate success with our reliable cloud computing services and DevOps solutions for seamless development, continuous delivery, and continuous improvement.</p>
            ...
            <div className="col-xxl-3 col-lg-4 col-sm-6">
              <div className="service-wrapper service-style-1">
                <div className="service-inner">
                  ...
                  <div className="bg-icon">
                    <img className="img-fluid" src={CrmColor} alt />
                  </div>
                  <div className="service-content">
                    <h5 className="service-title">Wordpress Development</h5>
                    <p>Professional WordPress development services delivering custom, scalable, and high-performance websites.</p>
