      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
          ...
          <div className="space-y-5">
            ...
            Empowering businesses with innovative cloud solutions. We transform digital infrastructure  through cutting-edge technology, ensuring scalability, security, and seamless integration for sustainable growth.            </p>
          ...
          {/* <div>
            ...
            <ul className="grid grid-cols-2 gap-2">
             ...
             <h6 className="widget-title">Quick Links</h6>
                  <ul className="list-unstyled list-col-2 mb-0">
                    {quickLinks.map((link, index) => (
                      <li key={index}>
